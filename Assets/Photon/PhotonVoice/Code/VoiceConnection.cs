...
namespace Photon.Voice.Unity
{
    ...
    public class VoiceConnection : ConnectionHandler, ILoggable
    {
        ...
        protected virtual void OnOperationResponse(OperationResponse opResponse)
        {
            switch (opResponse.OperationCode)
            {
                case OperationCode.GetRegions:
                    if (opResponse.ReturnCode == ErrorCode.Ok && this.Settings != null && this.Settings.IsBestRegion && this.Client.RegionHandler != null)
                    {
